...
export class InMemOrderDataService implements InMemoryDbService {
    ...
    createDb() {
        ...
        let traders: any[] = [
            ...
            {id : 71, name : '开发公司', traderType : 'CCSTRADER', company : '', },
            {id : 72, name : '印尼公司', traderType : 'CCSTRADER', company : ''},
            {id : 73, name : '华南公司', traderType : 'CCSTRADER', company : ''},
            {id : 74, name : '华南公司', traderType : 'CCSTRADER', company : ''},

            {id : 81, name : '江苏晋和电力燃料有限公司', shortName: '晋和', traderType : 'CCSACCOUNTING', company : '', },
            {id : 82, name : '那曲瑞昌煤炭运销有限公司', shortName: '那曲', traderType : 'CCSACCOUNTING', company : '', },
            {id : 83, name : '郑州嘉瑞供应链管理有限公司 ', shortName: '嘉瑞', traderType : 'CCSACCOUNTING', company : '', },
            {id : 84, name : '山西瑞茂通供应链有限公司', shortName: '山瑞', traderType : 'CCSACCOUNTING', company : '', },
            {id : 85, name : '宁夏瑞茂通供应链管理有限公司	 ', shortName: '宁夏瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 86, name : '宁夏华运昌煤炭运销有限公司', shortName: '华运昌', traderType : 'CCSACCOUNTING', company : '', },
            {id : 87, name : '宁夏腾瑞达电力燃料有限公司', shortName: '腾瑞达', traderType : 'CCSACCOUNTING', company : '', },
            {id : 88, name : '陕西秦瑞丰煤炭运销有限公司', shortName: '秦瑞丰', traderType : 'CCSACCOUNTING', company : '', },
            {id : 89, name : '陕西吕通贸易有限公司', shortName: '吕通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 90, name : '新疆瑞茂通供应链管理有限公司', shortName: '新疆瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 91, name : '浙江瑞茂通供应链管理有限公司', shortName: '浙江瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 92, name : '浙江和辉电力燃料有限公司', shortName: '和辉', traderType : 'CCSACCOUNTING', company : '', },
            {id : 93, name : '江苏丰泰物资贸易有限公司', shortName: '丰泰', traderType : 'CCSACCOUNTING', company : '', },
            {id : 94, name : '宣威瑞茂通商贸有限公司', shortName: '宣威瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 95, name : '江西瑞茂通供应链管理有限公司', shortName: '江西瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 96, name : '上海瑞易供应链管理有限公司', shortName: '上海瑞易', traderType : 'CCSACCOUNTING', company : '', },
            {id : 97, name : '深圳前海瑞茂通供应链平台服务有限公司 ', shortName: '前海瑞茂通', traderType : 'CCSACCOUNTING', company : '', },
            {id : 98, name : '乌海市嘉运和商贸有限公司', shortName: '乌海嘉运和', traderType : 'CCSACCOUNTING', company : '', },
            {id : 99, name : '河南腾瑞能源产业开发有限公司', shortName: '河南腾瑞', traderType : 'CCSACCOUNTING', company : '', },
        ...
        if (reportsLocal) {
            reports = JSON.parse(reportsLocal)
        }
